...
const Header = () => {
  return (
    <div className="h-[535px] w-full">
      <div className="bg-[url('src/assets/John-wick.svg')] bg-contain bg-no-repeat h-full">
        ...
        <div className="w-[350px] mt-10 ml-2 flex flex-col items-start">
          <h1 className="text-white text-[25px] font-bold leading-10 w-[250px] ">
          ...
          <button className="bg-[#BE123C] text-white px-2 py-2 rounded-md mt-4 hover:bg-[#8d364c]">
            Watch later
          </button>
        </div>
      </div>
